    ...
    return (
        <ScrollView style={{ backgroundColor: "#ffffffff", height: '100%' }}>
            ...
            <View style={{ width: '90%', alignSelf: 'center', marginTop: '9%' }}>
                ...
                <TextInput placeholder='Phone' value="(+1) 23456789" style={{ borderBottomWidth: 1, borderColor: '#ccc', paddingVertical: 8, width: '45%', top: 0 }} />
            </View>
            <View style={{ width: '90%', alignSelf: 'center', marginTop: '20%', justifyContent: 'center', alignItems: 'center', }}>
                <TouchableOpacity onPress={() => navigation.navigate("Profile")} style={{ height: 50, backgroundColor: "rgba(164, 123, 104, 1)", justifyContent: 'center', width: 300, alignItems: 'center', borderRadius: 20 }}>
