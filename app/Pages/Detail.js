...
const Detail = ({navigation}) => {
  return (
    <ScrollView style={{ backgroundColor: "#fefcfcff" ,height:'1000%'}}>
      <View style={{ width: "100%", height: '250', backgroundColor: "white", alignItems: 'center' }}>
        ...
        <View style={{ width: '100%', backgroundColor: 'white', padding: 15, height: 80 }}>
          ...
          <Text style={{ fontWeight: 'bold' }}> Flared Lehenga {"\n"} Rs:45,000{"\n"} Rental Duration:7 Days{"\n"}</Text>
          <TouchableOpacity style={{ width: "20%", height: 30, backgroundColor: "rgba(164, 123, 104, 1)", justifyContent: 'center', alignItems: 'center', alignSelf: 'flex-end', marginRight: 15, borderRadius: 10, bottom: 40 }}>
            <Text style={{ fontSize: 17, fontFamily: 'Times New Roman', color: 'black' }} onPress={() => navigation.navigate("VTO")}>Try On</Text>
          </TouchableOpacity>
        </View>
        <View style={{ backgroundColor: 'white', padding: 15 }}>
          <Text style={{ fontWeight: 'bold' }}>Description:</Text>
          <Text style={{ fontWeight: 'bold' }}>Febric:</Text>
          <Text >Pishwas/ Dupatta: Organza,Lehnga: Color: Grey,Length: 44-46 inches,Model Size: S</Text>
        ...
        <View style={{ width: '100%', backgroundColor: 'white', height: 90 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 10, padding: 15, height: 50, backgroundColor: 'white', alignItems: 'center' }}>
            ...
            <View style={{ width: 40, backgroundColor: "#c5c0c0ff", height: 40, borderRadius: 50, alignItems: 'center', justifyContent: 'center' }} >
          ...
          <View style={{ height: 90, backgroundColor: 'white', justifyContent: 'center', width: "100%", alignItems: 'center' }}>
            <TouchableOpacity   onPress={() => navigation.navigate("Cart")} style={{ height: 50, backgroundColor: "rgba(164, 123, 104, 1)", justifyContent: 'center', width: 300, alignItems: 'center', borderRadius: 20 }}>
