    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F1DCD1' }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
        ...
        <View style={{ paddingHorizontal: 24, marginTop: 24, gap: 16 }}>
          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('ViewProduct')}>
            <Feather name="package" size={20} color="#fff" />
            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '700', marginLeft: 10 }}>View Product</Text>
          </TouchableOpacity>

          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderWidth: 1, borderColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('PickUp')}>
          ...
          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderWidth: 1, borderColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('Delivery')}>
            <Ionicons name="car-outline" size={22} color="#8E6652" />
            <Text style={{ color: '#8E6652', fontSize: 16, fontWeight: '700', marginLeft: 10, flex: 1 }}>Delivery Management</Text>
            <Feather name="chevron-right" size={20} color="#8E6652" />
          </TouchableOpacity>

          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderWidth: 1, borderColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('OrderPayment')}>
            <Ionicons name="clipboard-outline" size={22} color="#8E6652" />
            <Text style={{ color: '#8E6652', fontSize: 16, fontWeight: '700', marginLeft: 10, flex: 1 }}>Order Management</Text>
            <Feather name="chevron-right" size={20} color="#8E6652" />
          </TouchableOpacity>

          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderWidth: 1, borderColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('ComplaintMg')}>
            <Ionicons name="alert-circle-outline" size={22} color="#8E6652" />
            <Text style={{ color: '#8E6652', fontSize: 16, fontWeight: '700', marginLeft: 10, flex: 1 }}>Complain Management</Text>
            <Feather name="chevron-right" size={20} color="#8E6652" />
          </TouchableOpacity>

          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderWidth: 1, borderColor: '#8E6652', padding: 16, borderRadius: 12 }} onPress={() => navigation.navigate('AccountSetting')}>
